...
const ::Mesh::TStaticMesh XYPlusPlane{
    {A, ZPlus, Color::Blue}, {C, ZPlus, Color::Blue}, {B, ZPlus, Color::Blue},
    {B, ZPlus, Color::Blue}, {C, ZPlus, Color::Blue}, {D, ZPlus, Color::Blue}};
const ::Mesh::TStaticMesh XYMinPlane{
    {G, ZMin, Color::DarkBlue}, {E, ZMin, Color::DarkBlue},
    {F, ZMin, Color::DarkBlue}, {G, ZMin, Color::DarkBlue},
    {F, ZMin, Color::DarkBlue}, {H, ZMin, Color::DarkBlue}};
const ::Mesh::TStaticMesh XZPlusPlane{
    {C, YPlus, Color::Green}, {G, YPlus, Color::Green},
    {D, YPlus, Color::Green}, {D, YPlus, Color::Green},
    {G, YPlus, Color::Green}, {H, YPlus, Color::Green}};
const ::Mesh::TStaticMesh XZMinPlane{
    {E, YMin, Color::DarkGreen}, {A, YMin, Color::DarkGreen},
    {B, YMin, Color::DarkGreen}, {E, YMin, Color::DarkGreen},
    {B, YMin, Color::DarkGreen}, {F, YMin, Color::DarkGreen}};
const ::Mesh::TStaticMesh YZPlusPlane{
    {B, XPlus, Color::Red}, {D, XPlus, Color::Red}, {F, XPlus, Color::Red},
    {F, XPlus, Color::Red}, {D, XPlus, Color::Red}, {H, XPlus, Color::Red}};
const ::Mesh::TStaticMesh YZMinPlane{
    {C, XMin, Color::DarkRed}, {A, XMin, Color::DarkRed},
    {E, XMin, Color::DarkRed}, {C, XMin, Color::DarkRed},
    {E, XMin, Color::DarkRed}, {G, XMin, Color::DarkRed}};
} // namespace Model
...
const ::Mesh::TStaticMesh Model::Grid() {
  ...
  for (int x = 0; x < 100; x++) {
    for (int z = 0; z < 100; z++) {
      if ((x + z) % 2 == 1) {
        ::Mesh::TStaticMesh element =
            Move(AdjustColor(oddCell, glm::vec3(xColorAdjustment * x, 0.0f,
                                                zColorAdjustment * z)),
                 glm::vec3(-100 + x * 2, -1.0f, -100 + z * 2));
        grid.insert(grid.end(), element.begin(), element.end());
      } else {
        ::Mesh::TStaticMesh element =
            Move(AdjustColor(evenCell, glm::vec3(xColorAdjustment * x, 0.0f,
                                                 zColorAdjustment * z)),
                 glm::vec3(-100 + x * 2, -1.0f, -100 + z * 2));
        grid.insert(grid.end(), element.begin(), element.end());
      }
...
const ::Mesh::TStaticMesh Model::SimpleTank() {
  ::Mesh::TStaticMesh lower(Move(Scale(Box(), glm::vec3(2.0f, 0.5f, 1.5f)),
                                 glm::vec3(0.0f, 0.5f, 0.0f)));
  ::Mesh::TStaticMesh middle(Move(Scale(Box(), glm::vec3(1.0f, 0.5f, 1.0f)),
                                  glm::vec3(0.0f, 1.5f, 0.0f)));
  ::Mesh::TStaticMesh gun(Move(Scale(Box(), glm::vec3(1.5f, 0.25f, 0.25f)),
...
const ::Mesh::TStaticMesh Model::Scale(::Mesh::TStaticMesh mesh,
...
const ::Mesh::TStaticMesh Model::Move(::Mesh::TStaticMesh mesh,
...
const ::Mesh::TStaticMesh Model::ChangeColor(::Mesh::TStaticMesh mesh,
                                             glm::vec3 color) {
  for (auto &item : mesh) {
    item.c = color;
  }
...
const ::Mesh::TStaticMesh Model::AdjustColor(::Mesh::TStaticMesh mesh,
                                             glm::vec3 color) {
  for (auto &item : mesh) {
    item.c += color;
  }

...
std::vector<UI::Vertex> SelectionRectangle(const glm::vec2 &pointA,
  ...
  int thickness = 2;
  std::vector<UI::Vertex> leftbar(
      generateSquare(xlowerleft, ylowerleft, thickness, h, color));
  std::vector<UI::Vertex> rightbar(generateSquare(
      xlowerleft + w, ylowerleft, thickness, h + thickness, color));
  std::vector<UI::Vertex> lowbar(
      generateSquare(xlowerleft, ylowerleft, w, thickness, color));
  std::vector<UI::Vertex> highbar(
      generateSquare(xlowerleft, ylowerleft + h, w, thickness, color));

...
private:
  ...
  // The arcball rotation consists of two parts. The last one does the rotation
  // on the y-axis so around the center on xz plane, the second one is about the
  // updown around the x-axis.
